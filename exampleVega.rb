...
# Pie chart with the Vega backend.
plot_vega = Plot.new('Vega','pie',web_browsers_title,web_browsers_shares,web_browsers_names)
plot_vega.save_svg("pieVega_browsers.svg")
...
# Pie chart with the Vega backend.
plot_vega = Plot.new('Vega','pie',world_cup_title,world_cup_wins,world_cup_names)
plot_vega.save_svg("pieVega_FIFA.svg")
